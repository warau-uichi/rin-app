...
export default function TwoColumnWithImageAndProfilePictureReview({
  subheading = "",
  heading = "黄土よもぎ蒸し",
  description = "本場韓国の黄土の座器と、草は天然・無農薬の国産100%よもぎを使用しており安心安全です。さらに麻炭、国内で培養された酵母・乳酸菌・光合成細菌などの微生物酵素も配合されているので、あなたの身体に必要な働きをしてくれます。水素水を使った足湯付きです。",
  testimonials = null,
  textOnLeft = false
}){
  /*
